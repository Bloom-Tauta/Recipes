...
class FavouritesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create favourite" do
    assert_difference("Favourite.count") do
      post favourites_url, params: { favourite: { recipe_id: @favourite.recipe_id, user_id: @favourite.user_id } }, as: :json
    end
  ...
  test "should update favourite" do
    patch favourite_url(@favourite), params: { favourite: { recipe_id: @favourite.recipe_id, user_id: @favourite.user_id } }, as: :json
    assert_response :success
  end
